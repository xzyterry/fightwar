 ...
 */
contract EnumerableNFT is NFTBase, IERC721Enumerable {
    /**
     ...
     */
    function _removeNFT(address _from, uint256 _tokenId)
        internal
        virtual
        override
    {
     ...
     */
    function _addNFT(address _to, uint256 _tokenId) internal virtual override {
     ...
     */
    function _getNFTCount(address _owner)
        internal
        view
        virtual
        override
